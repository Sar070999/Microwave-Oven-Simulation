...
void time_display_screen(void)
{
    ...
    clcd_putch(min/10 + '0',(0x80 + 9));
    clcd_putch(min%10 + '0',(0x80 + 10));
    clcd_putch(':',(0x80 + 11));

    clcd_putch(sec/10 + '0',(0x80 + 12));
    clcd_putch(sec%10 + '0',(0x80 + 13));


    clcd_print(" 4.Start/Resume",(0xC0 + 0));
    clcd_print(" 5.Pause",(0x90 + 0));
    clcd_print(" 6.Stop",(0xD0 + 0));

    if(sec==0 && min ==0)
    {
        clear_screen();
        clcd_print("  Timer Up !!", (0xC0 + 0));
        RC1 = 1 ;
...
void menu_display_screen(void)
{
   clcd_print("1.Micro",(0x80 + 0));
   clcd_print("2.Grill",(0xC0 + 0));
   clcd_print("3.Convection",(0x90 + 0));
   clcd_print("4.Start",(0xD0 + 0));
...
void power_on_screen(void)
{
    ...
    clcd_print(" Microwave Oven ",(0x90 + 0));
     _delay((unsigned long)((3000)*(20000000/4000.0)));
}
...
void set_temp(unsigned char key, int reset_flag)
{
    ...
    if(reset_flag == 0x10)
    {
        ...
        flag=0;
        key = 0xFF;
        clcd_print(" SET TEMP(oC) ",(0x80 + 0));
        clcd_print(" TEMP = ",(0xC0 + 0));
    ...
    else if(key == '#')
    {
        ...
        clcd_print("  Pre-Heating ",(0x80 + 0));
        clcd_print("Time Rem.= ",(0x90 + 0));
        sec =03;
        TMR2ON =1;
        while(sec!=0)
        {

            clcd_putch((sec/10)%10 + '0',(0x90 + 12));
            clcd_putch(sec%10 + '0',(0x90 + 13));
        }
        if(sec==0)
        {
           clear_screen();
    ...
    if(wait++ ==20)
    {
       ...
       clcd_putch(temp/100 + '0' ,(0xC0 + 9));
       clcd_putch((temp/10)%10 + '0' ,(0xC0 + 10));
       clcd_putch(temp%10 + '0' ,(0xC0 + 11));
...
void set_time(unsigned char key, int reset_flag)
{
    ...
    if(reset_flag == 0x10)
    {
        ...
        blink_pos=0;
        key = 0xFF;
        clcd_print("SET TIME (MM:SS)",(0x80 + 0));
